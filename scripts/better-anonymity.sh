...
# https://www.stigviewer.com/stig/apple_macos_12_monterey/2022-01-19/
# https://www.stigviewer.com/stig/apple_macos_12_monterey/2022-01-19/MAC-3_Sensitive/
# https://csrc.nist.gov/publications/detail/sp/800-219/final

"
3.4.10
OpenSSH
The implementation of OpenSSH that is included with macOS does not use a 
FIPS 140-2 validated cryptographic module. Organizations can reference 
FIPS 140-2 Annex A for a list of FIPS 140-2 approved algorithms that 
can be configured for use with OpenSSH 
(https://csrc.nist.gov/csrc/media/publications/fips/140/2/final/documents/fips1402annexa.pdf). 
OpenSSH should not be used unless approved by the AO.
"

# ---------------------------------------------------------
# -----------------------SECURITY--------------------------
# Anti-malware software, Antivirus software, Data masking 
# software, Data loss prevention, Event management 
# software, access management
# Identifiable, but not accessible.
# ---------------------------------------------------------
# ---------------------------------------------------------
...
# ---------------------------------------------------------
# ------------------------PRIVACY--------------------------
# Ad and tracker blockers, Browser extensions/add-ons, 
# Email services, Encrypted messaging, File encryption 
# software, Password managers, Private browsers, 
# Private search engines, Web proxies
# Accessible, but not identifiable.
# ---------------------------------------------------------
# ---------------------------------------------------------
...
# ---------------------------------------------------------
# -----------------------ANONYMITY-------------------------
# Not identifiable AND not accessible. Indistinguishable.
# - https://anonymousplanet.org/guide.html
# - https://github.com/Anon-Planet/thgtoa
# - https://github.com/spix-777/annNet
# ---------------------------------------------------------